package com.tracetech.flux.config.securite;

import com.tracetech.flux.config.securite.filter.CustomerAuthentificationFilter;
import com.tracetech.flux.config.securite.filter.CustomerAuthorizationFilter;
import com.tracetech.flux.util.StaticValue;
